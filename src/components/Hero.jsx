...
// import hero from "../assets/images/person.png";
import hero from "../assets/logo.svg";
const Hero = () => {
  const social_media = [
    {
      icon: "logo-instagram",
      link: "https://www.instagram.com/atenciajaramillo/",
    },
    { icon: "logo-github", link: "https://github.com/JATENCIA" },
    {
      icon: "logo-linkedin",
      link: "https://www.linkedin.com/in/joseantonioatenciajaramillo/",
    },
    { icon: "logo-twitter", link: "https://twitter.com/joseantonioate4" },
  ];
  return (
    <section
      id="home"
